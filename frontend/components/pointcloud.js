...
export default function PointCloud({onLoad}) {
...
/*
Need to add UI Controls to the viewer using leva, 
Need to measure volume inside the pointcloud and display it in the UI,
Need to add a button to the UI to download the pointcloud as a .laz file,
Need to add a button to send POST request to python server to run computations
